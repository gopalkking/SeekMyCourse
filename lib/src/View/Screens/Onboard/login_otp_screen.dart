  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:Text('Verification',style: Theme.of(context).textTheme.titleMedium,)
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            24.vspace,
             Text('Enter your OTP code here',style: Theme.of(context).textTheme.bodyMedium),
             16.vspace,
             Pinput(
              ...
              height: 50, color: theme.splashColor,onPressed: (){},textcolor: Color(0xff000000),),
              36.vspace,
             Row(
